...
Source0  : https://dovecot.org/releases/2.3/dovecot-2.3.21.tar.gz
Source1  : dovecot.service
Source2  : dovecot.tmpfiles
Source3  : https://dovecot.org/releases/2.3/dovecot-2.3.21.tar.gz.sig
...
%prep
%setup -q -n dovecot-2.3.21
cd %{_builddir}/dovecot-2.3.21
pushd ..
cp -a dovecot-2.3.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711741623
